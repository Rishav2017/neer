                    ...
                    @if($category->subcategories->isNotEmpty())
                        <div class="bg-[#0a0a0a]/50">
                            @foreach($category->subcategories as $subcategory)
                                <div class="flex items-center justify-between px-4 py-3 border-b border-[#3E3E3A] last:border-b-0 hover:bg-[#1f1f1e] transition-colors">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        <span class="text-xs text-gray-500 mr-4">{{ $subcategory->products->count() }} products</span>
